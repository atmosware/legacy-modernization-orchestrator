...
> [`nexia-delivery-planning` skill](../skills/nexia-delivery-planning/SKILL.md)
...
Trigger conditions and full method for the three optional artifacts: [`../skills/nexia-delivery-planning/EXTENDED_ARTIFACTS.md`](../skills/nexia-delivery-planning/EXTENDED_ARTIFACTS.md).

All HTML diagrams follow [`../skills/nexia-delivery-planning/STANDARDS.md`](../skills/nexia-delivery-planning/STANDARDS.md) and must pass `node scripts/validate-mermaid.js`.

---

## Definition of Done
> All items must be ✅ before the plan is considered complete.
> Authoritative checklist: [`../skills/nexia-delivery-planning/SKILL.md`](../skills/nexia-delivery-planning/SKILL.md)
