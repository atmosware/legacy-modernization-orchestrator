...
## Instructions
Read the full skill file at `.github/skills/nexia-devops-infra/SKILL.md` before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.
...
- Backend code artifacts must exist in `ai-driven-development/development/backend_development/`
