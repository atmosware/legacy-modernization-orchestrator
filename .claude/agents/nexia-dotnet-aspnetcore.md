...
## Role
**Senior .NET Engineer** — Implement the backend using .NET 9 + ASP.NET Core, applied as a Tier-2 supplement to `backend-development`.

## Instructions
Read the full skill file at `.github/skills/nexia-dotnet-aspnetcore/SKILL.md` before taking any action. Apply this skill in conjunction with `backend-development/SKILL.md`. Follow every step exactly.
