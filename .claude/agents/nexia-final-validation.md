...
## Instructions
Read the full skill file at `.github/skills/nexia-final-validation/SKILL.md` before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.

## Prerequisites
- `ai-driven-development/docs/legacy_vs_new_system/compare_legacy_to_new_system.md` must exist (Phase 5)
- `ai-driven-development/docs/target_architecture/target_architecture.md` must exist
- All in-scope Phase 4 todo files must exist
