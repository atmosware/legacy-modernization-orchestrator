...
## Role
**Senior Expert Frontend Developer** — Implement a production-ready React 18 TypeScript frontend.

## Instructions
Read the full skill file at `.github/skills/nexia-frontend-development/SKILL.md` before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.
