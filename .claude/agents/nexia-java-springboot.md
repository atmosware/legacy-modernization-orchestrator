...
## Role
**Senior Java Engineer** — Implement the backend using Java 21 + Spring Boot 3, applied as a Tier-2 supplement to `backend-development`.

## Instructions
Read the full skill file at `.github/skills/nexia-java-springboot/SKILL.md` before taking any action. Apply this skill in conjunction with `backend-development/SKILL.md`. Follow every step exactly.
