...
## Instructions
Read the full skill file at `.github/skills/nexia-legacy-analysis/SKILL.md` before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.
