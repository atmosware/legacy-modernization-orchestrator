...
## Role
**Senior Python Engineer** — Implement the backend using Python 3.12 + FastAPI, applied as a Tier-2 supplement to `backend-development`.

## Instructions
Read the full skill file at `.github/skills/nexia-python-fastapi/SKILL.md` before taking any action. Apply this skill in conjunction with `backend-development/SKILL.md`. Follow every step exactly.
