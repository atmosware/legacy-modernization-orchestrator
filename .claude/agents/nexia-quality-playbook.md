...
## Role
**Cross-Cutting Quality Reference** — Provide decision trees and quality gates applicable across all phases. Advisory only; no standalone deliverable.

## Instructions
Read `.github/skills/nexia-quality-playbook/SKILL.md` and apply the relevant decision tree or quality criteria to the calling phase's context. Embed findings as inline notes or ADR entries in the active phase's output document.
