...
## Argument
Path to legacy analysis and target architecture artifacts, plus database connection details.

## Instructions
Read `.github/skills/nexia-data-migration/SKILL.md` in full before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.
