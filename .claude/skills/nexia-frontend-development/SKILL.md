...
## Role
Senior Expert Frontend Developer — React / Vue / Angular / Svelte TypeScript frontend. Design system components, TanStack Query / Zustand / Pinia / NgRx, Axios, Vitest/Playwright testing.
