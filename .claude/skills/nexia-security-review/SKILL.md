...
## Role
Senior Application Security Engineer — Phase 4g. Systematically audit the modernized system against OWASP Top 10 and security best practices before go-live.

## Argument
Project name or path to target architecture and development artifacts to review.

## Instructions
Read `.github/skills/nexia-security-review/SKILL.md` in full before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.
