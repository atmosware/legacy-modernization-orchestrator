...
## Argument
Path or description of the legacy project to analyze.

## Instructions
Read `.github/skills/nexia-legacy-analysis/SKILL.md` in full before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.
