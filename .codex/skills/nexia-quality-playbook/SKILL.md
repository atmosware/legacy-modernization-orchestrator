...
## Role
Cross-Cutting Quality Reference — Apply architecture quality gates, design patterns, testing strategy, and code quality standards across all modernization phases.

## Argument
Phase name or quality concern to evaluate.

## Instructions
Read `.github/skills/nexia-quality-playbook/SKILL.md` in full before taking any action. Follow every step exactly — no skipping, reordering, or summarizing. Validate the Definition of Done checklist before completing.
