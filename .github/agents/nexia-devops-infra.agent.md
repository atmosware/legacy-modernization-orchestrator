...
> **Parallelism:** 4h can start as soon as Phase 3 is complete and the relevant deployable artifacts have begun. Safe to run in parallel with 4b, 4c, 4d, 4e, 4i, 4f. See the [Phase 4 Parallelism Matrix](./nexia-orchestrator.agent.md#parallelizable-phases-after-phase-3--scope-confirmed).
...
> [`devops-infra` skill](../skills/nexia-devops-infra/SKILL.md)
...
> Authoritative checklist: [`../skills/nexia-devops-infra/SKILL.md`](../skills/nexia-devops-infra/SKILL.md)
