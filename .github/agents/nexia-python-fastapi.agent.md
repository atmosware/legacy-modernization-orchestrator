...
> [`python-fastapi` skill](../skills/nexia-python-fastapi/SKILL.md)
...
> Authoritative checklist: [`../skills/nexia-python-fastapi/SKILL.md`](../skills/nexia-python-fastapi/SKILL.md)
