...
> **Parallelism:** 4g requires at least one of 4b/4c/4d/4e/4i complete (code must exist to audit). Can overlap with Phase 5. See the [Phase 4 Parallelism Matrix](./nexia-orchestrator.agent.md#parallelizable-phases-after-phase-3--scope-confirmed).
...
> [`security-review` skill](../skills/nexia-security-review/SKILL.md)
...
> Authoritative checklist: [`../skills/nexia-security-review/SKILL.md`](../skills/nexia-security-review/SKILL.md)
