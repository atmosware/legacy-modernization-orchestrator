...
| 3.5 | `delivery-planning` | Optional (offered after Phase 3; never blocking) |
...
### `delivery-planning` _(Phase 3.5 — Optional)_
...
**Skill file:** `.github/skills/delivery-planning/SKILL.md`  
