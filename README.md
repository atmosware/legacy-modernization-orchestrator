...
| 3.5 | `nexia-delivery-planning` | Implementation planning & effort estimation — alternative delivery strategies, team-size × with/without-AI scenario matrix, WBS, dependencies, parallel work streams _(optional, non-blocking; offered after Phase 3)_ |
